...
import com.localmarketplace.config.CacheConfiguration;
...
import com.localmarketplace.security.AuthoritiesConstants;
...
import com.localmarketplace.service.mapper.UserMapper;
import com.localmarketplace.web.rest.errors.ExceptionTranslator;
import com.localmarketplace.web.rest.vm.ManagedUserVM;
...
public class UserResourceIntTest {
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder(AuthoritiesConstants.USER, AuthoritiesConstants.ADMIN, AuthoritiesConstants.CONSUMER, AuthoritiesConstants.PROVIDER)));
    }
