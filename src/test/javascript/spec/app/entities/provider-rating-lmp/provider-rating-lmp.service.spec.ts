...
describe('Service Tests', () => {
    ...
    describe('ProviderRatingLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ProviderRatingLmpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/provider-ratings';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ProviderRatingLmp', () => {

                let entity: ProviderRatingLmp;
                service.find(123).subscribe((_entity: ProviderRatingLmp) => {
                    entity = _entity;
                });
