...
describe('Service Tests', () => {
    ...
    describe('ServiceAppointmentLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ServiceAppointmentLmpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-appointments';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ServiceAppointmentLmp', () => {

                let entity: ServiceAppointmentLmp;
                service.find(123).subscribe((_entity: ServiceAppointmentLmp) => {
                    entity = _entity;
                });
