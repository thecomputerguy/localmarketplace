...
describe('Service Tests', () => {
    ...
    describe('ServiceCategoryLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ServiceCategoryLmpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-categories';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ServiceCategoryLmp', () => {

                let entity: ServiceCategoryLmp;
                service.find(123).subscribe((_entity: ServiceCategoryLmp) => {
                    entity = _entity;
                });
