...
describe('Service Tests', () => {
    ...
    describe('ServiceProviderMapLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ServiceProviderMapLmpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-provider-maps';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ServiceProviderMapLmp', () => {

                let entity: ServiceProviderMapLmp;
                service.find(123).subscribe((_entity: ServiceProviderMapLmp) => {
                    entity = _entity;
                });
