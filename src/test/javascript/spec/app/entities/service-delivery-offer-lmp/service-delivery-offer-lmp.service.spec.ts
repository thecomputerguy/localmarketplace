...
describe('Service Tests', () => {
    ...
    describe('ServiceDeliveryOfferLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ServiceDeliveryOfferLmpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-delivery-offers';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ServiceDeliveryOfferLmp', () => {

                let entity: ServiceDeliveryOfferLmp;
                service.find(123).subscribe((_entity: ServiceDeliveryOfferLmp) => {
                    entity = _entity;
                });
