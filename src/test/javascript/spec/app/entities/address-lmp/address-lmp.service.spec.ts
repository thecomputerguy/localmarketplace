...
describe('Service Tests', () => {
    ...
    describe('AddressLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AddressLmpService);
        ...
        describe('Service methods', () => {
            ...
            it('should return AddressLmp', () => {

                let entity: AddressLmp;
                service.find(123).subscribe((_entity: AddressLmp) => {
                    entity = _entity;
                });
