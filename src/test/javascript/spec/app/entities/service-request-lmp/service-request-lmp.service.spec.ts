...
describe('Service Tests', () => {
    ...
    describe('ServiceRequestLmp Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ServiceRequestLmpService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-requests';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ServiceRequestLmp', () => {

                let entity: ServiceRequestLmp;
                service.find(123).subscribe((_entity: ServiceRequestLmp) => {
                    entity = _entity;
                });
