...
@Injectable()
export class CustomerLmpPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.customerModalRef(component, new CustomerLmp());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    customerModalRef(component: Component, customer: CustomerLmp): NgbModalRef {
